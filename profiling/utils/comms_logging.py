...
import math
from profiling.utils import log_dist
...
class CommsLogger:
    ...
    def __init__(self):
        from profiling.comm.constants import COMMS_LOGGER_VERBOSE_DEFAULT, COMMS_LOGGER_DEBUG_DEFAULT, COMMS_LOGGER_PROF_OPS_DEFAULT, COMMS_LOGGER_PROF_ALL_DEFAULT, COMMS_LOGGER_ENABLED_DEFAULT
        self.comms_dict = {}
    ...
    def log_all(self, print_log=True, show_straggler=False):
        import torch
        from profiling.utils.timer import trim_mean
        import profiling.comm as dist
        from profiling.comm.reduce_op import ReduceOp
        if print_log:
            print(
